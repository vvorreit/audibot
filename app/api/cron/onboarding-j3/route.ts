      ...
      await sendMail({
        ...
        html: emailWrapper({
          ...
          content: `
            ...
            ${bodyText(`Cette semaine, les utilisateurs OptiBot ont économisé en moyenne <strong>47 minutes de saisie</strong>. Vous êtes inscrit${firstName ? `, ${firstName},` : ""} mais vous n'avez pas encore testé le remplissage automatique.`)}
            ${infoBox(`🤖 En pratique : scannez une carte mutuelle → OptiBot remplit Almerys, Wemind, Viamedis en 10 secondes. Pas de copier-coller, pas d'erreur de NSS.`)}
