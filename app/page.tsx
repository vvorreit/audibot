              ...
              <div className="space-y-8">
                {[
                  { 
                    ...
                    desc: "Contrairement aux solutions cloud, l'analyse se fait sur VOTRE ordinateur. Aucune donnée de santé de vos patients — NSS, audiogramme, données ORL — n'est stockée sur nos serveurs.",
                    icon: Lock 
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: "AudiBot fonctionne avec Auditdata et les portails mutuelles du marché (Almerys, Viamedis, Ameli Pro). Un logiciel ou une mutuelle manquant ? Contactez-nous — nous l'intégrons en 5 jours ouvrés.",
                    icon: Layers
                  },
                  {
