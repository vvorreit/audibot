...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez toutes les fonctionnalités AudiBot : lecture OCR de cartes mutuelles et prescriptions ORL, remplissage automatique des portails, suivi tiers payant, gestion d'équipe, sécurité AES-256 et bien plus.",
  openGraph: {
