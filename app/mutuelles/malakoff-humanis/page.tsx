...
export const metadata: Metadata = {
  title: "AudiBot × Malakoff Humanis — Tiers payant optique automatisé",
  description:
    "Remplissez automatiquement vos demandes tiers payant Malakoff Humanis avec AudiBot. Smart Fill universel disponible pour les opticiens.",
  alternates: { canonical: "https://audibot.fr/mutuelles/malakoff-humanis" },
};
...
const data: PortailDetailData = {
  ...
  networkDescription:
    "Malakoff Humanis est un acteur majeur de la retraite complémentaire et de la santé en entreprise. AudiBot simplifie la saisie tiers payant pour les opticiens.",
