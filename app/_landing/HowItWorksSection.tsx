    ...
    <section id="comment-ca-marche" className="py-24 bg-slate-50 px-6 border-y border-slate-100">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-2xs font-black uppercase tracking-[0.3em] text-blue-600 mb-4">La Solution</h2>
          ...
          {[
            {
              step: "01",
              title: "Scannez",
              desc: "Photo ou PDF de la carte mutuelle et de l'ordonnance — depuis votre PC ou directement depuis votre téléphone via QR code.",
              icon: FileText,
            ...
            },
            {
              step: "02",
              title: "OptiBot lit",
              desc: "NSS, corrections optiques, numéro adhérent, dates de validité — tout est extrait en quelques secondes, sur votre machine.",
              icon: Search,
              color: "bg-blue-600 shadow-blue-100",
            },
            {
              ...
              desc: "L'extension Chrome remplit le portail mutuelle ou votre ERP automatiquement. Almerys, Wemind, Viamedis, LivebyOptimum...",
            ...
            },
            {
              ...
              desc: "Smart Fill détecte et remplit n'importe quel portail. Nouveau portail ? Enregistrez une fois, OptiBot le rejoue pour toujours.",
              icon: Globe,
              color: "bg-blue-600 shadow-blue-100",
              badge: "Nouveau",
            },
