...
import { LayoutDashboard, Users, ShieldCheck, CreditCard, User, LogOut, Menu, X, ChevronDown, LifeBuoy, FileText } from "lucide-react";
...
export default function NavMenu() {
  ...
  const navLinks = [
    ...
    { href: "/tiers-payant", label: "Tiers-payant", icon: FileText, show: Boolean(session) },
