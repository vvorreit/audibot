/* ── Smart Fill Aliases & Blacklist ─────────────────────────────────────── */
/* Exports: SMART_FILL_ALIASES, SMART_FILL_BLACKLIST. ~700 lignes */
...
export var SMART_FILL_ALIASES = {
  ...
  typeConv: [
    /* standard — uniquement les alias spécifiques (pas "convention" ou "regime" seuls) */
    "typeconv", "type_conv", "type_convention",
    "code_convention", "codeconvention",
    /* variations portails */
    "nature_convention", "codeConvention", "type_prise_en_charge",
    "convention_code", "code_conv", "type_couverture",
    "convention_type",
    /* Almerys ROC */
    "typeConvention",
    /* camelCase */
    "typeConv", "codeConv", "conventionType",
    /* data-testid */
    "convention-type", "coverage-type",
  ],
  dateDebutValidite: [
  ...
  /* ══════════════════════════════════════════════════════════════════════
   *  REGIME OBLIGATOIRE (RO) — SECURITE SOCIALE
   * ══════════════════════════════════════════════════════════════════════ */
  regimeObligatoire: [
    "regime_obligatoire", "regime_obligatoire_nom", "ro_nom", "caisse_ro",
    "regime_ro", "organisme_ro", "caisse_securite_sociale", "caisse_cpam",
    "caisse_assurance_maladie", "regime_base", "regime_general",
    "regimeObligatoire", "roNom", "caisseRO", "regimeBase",
    "regime-obligatoire", "caisse-ro",
  ],
  roCodeRegime: [
    "code_regime", "ro_code_regime", "regime_code", "code_ro",
    "codeRegime", "roCodeRegime", "regimeCode",
    "code-regime",
  ],
  roCodeCentre: [
    "code_centre", "centre_ro", "code_centre_ro", "centre_cpam",
    "code_caisse", "code_organisme_ro", "centre_securite_sociale",
    "codeCentre", "centreRO", "codeCaisse",
    "code-centre",
  ],
  roTauxPEC: [
    "taux_pec", "taux_pec_ro", "taux_prise_en_charge", "taux_ro",
    "taux_remboursement", "taux_couverture_ro", "pec_ro", "taux_base",
    "taux_securite_sociale", "taux_secu", "taux_amo",
    "tauxPEC", "tauxPecRO", "tauxRemboursement", "tauxRO",
    "taux-pec", "taux-ro",
  ],
  roExoneration: [
    "exoneration", "exoneration_ticket", "exoneration_type", "type_exoneration",
    "exoneration_type_id", "exoneration_tm", "ticket_moderateur",
    "exo_ticket", "code_exoneration", "motif_exoneration",
    "ald", "is_ald", "affection_longue_duree",
    "exonerationTicket", "typeExoneration", "exonerationTypeId",
    "exoneration-ticket", "exoneration-type",
  ],
  roPieceJustificative: [
    "piece_justificative", "piece_justificative_type", "piece_justificative_type_id",
    "justificatif", "type_justificatif", "pj_type", "pj_ro",
    "support_droits", "type_support", "justificatif_droits",
    "pieceJustificative", "pieceJustificativeTypeId", "typeJustificatif",
    "piece-justificative",
  ],
  roNatureAssurance: [
    "nature_assurance", "nature_assurance_type", "nature_assurance_type_id",
    "type_assurance", "nature_risque", "risque", "nature_prestation",
    "nature_garantie", "type_risque_ro",
    "natureAssurance", "natureAssuranceTypeId", "typeAssurance", "natureRisque",
    "nature-assurance",
  ],
   ...
   * ══════════════════════════════════════════════════════════════════════ */
  civilite: [
    "civilite", "civilite_type", "civilite_type_id", "titre", "title", "salutation",
    "gender", "sexe", "mr_mrs", "civility", "anrede",
    "civiliteTypeId", "titreClient", "genderType",
    "civilite-type", "client-title",
  ],
  nomNaissance: [
    "nom_naissance", "nom_jeune_fille", "maiden_name", "birth_name",
    "nomjeuneille", "nomnaissance", "birthname", "maidenname",
    "nomDeNaissance", "nomJeuneFille", "birthName", "maidenName",
    "nom-naissance", "nom-jeune-fille",
  ],
  nomAssure: [
    "nom_assure", "assure_principal", "nom_assure_principal", "nom_titulaire",
    "subscriber_name", "insured_name", "holder_name",
    "nomAssure", "nomTitulaire", "subscriberName", "insuredName",
    "nom-assure", "assure-principal",
  ],
  rangNaissance: [
    "rang_naissance", "rang", "birth_rank", "beneficiary_rank",
    "rangNaissance", "birthRank", "rangBeneficiaire",
    "rang-naissance",
  ],
  numeroContrat: [
    "numero_contrat", "num_contrat", "no_contrat", "n_contrat", "nocontrat",
    "contract_number", "contract_id", "policy_number",
    "numeroContrat", "numContrat", "contractNumber", "policyNumber",
    "numero-contrat", "contract-number",
  ],
  nom: [
    /* français */
   ...
   * ══════════════════════════════════════════════════════════════════════ */
  nomOphtalmologue: [
    "nomophtalmologue", "nom_medecin", "nom_prescripteur", "prescripteur",
    "ophtalmologue", "ophtalmo", "nom_docteur", "nommedecin",
    "medecin_prescripteur", "nom prescripteur", "docteur prescripteur",
    "nom_ophtalmo", "prescriber", "doctor",
...
export var SMART_FILL_BLACKLIST = [
  ...
  "recherche",
  "autocomplete",
  /* Champs de recherche client — Optimum/LBO */
  ...
  "recaptcha",
  "hcaptcha",
  /* ── Champs ERP génériques — pas des données patient ── */
  /* Télétransmission technique */
  "aiguillage_sts",
  "formule_sts",
  "routage",
  "hote",
  ...
  "ref_pec",
  "code_service_amo",
  "code_service_amo_acs",
  "origine_piece_justificative",
  /* Accidents / situations spéciales */
  "no_accident",
  "no_organisme_accident",
  "date_accident",
  "date_maternite",
  "date_maternite_forcee",
  /* Fidélité / CRM */
  "standing",
  "nb_points",
  "point_operation",
  ...
  /* RGPD / consentement */
  "rgpd_commentaire",
  "date_consentement_marketing",
  "date_consentement_regime",
  /* Champs spécifiques non patient */
  "responsable_famille_nom",
  "date_lunaire",
  "sports_exerce",
  /* Prismes — saisis manuellement par l'opticien */
  "prisme",
  "prisme_1",
  "prisme_2",
  "base_1",
...
/* Exposer SMART_FILL_ALIASES sur globalThis pour les hot-patches */
globalThis.SMART_FILL_ALIASES = SMART_FILL_ALIASES;
