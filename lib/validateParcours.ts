/* Variables autorisees dans les etapes — aucune valeur patient reelle */
...
/**
 * Normalise les etapes avant validation :
 * - Retrocompatibilite selectors[] -> selector (format extension)
 * - Supprime les placeholders non-template comme "[VALEUR STATIQUE]"
 */
export function sanitizeEtapes(etapes: unknown[]): Record<string, unknown>[] {
  return etapes.map((e) => {
...
export function validateEtapes(etapes: unknown): boolean {
